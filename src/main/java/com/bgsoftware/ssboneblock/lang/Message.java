...
public enum Message {
    ...
    COMMAND_DESCRIPTION_SET_ONEBLOCK,
    COMMAND_DESCRIPTION_UNLOCK_ONEBLOCK,
    ...
    NO_MORE_PHASES,
    NO_PERMISSION,
    ONEBLOCK_DUPLICATE_LOCATION,
    ONEBLOCK_UNLOCK_SUCCESS_TIMED,
    ONEBLOCK_UNLOCK_SUCCESS,
    PHASE_PROGRESS,
    PHASE_STATUS,
    RELOAD_FILES,
    INVALID_DURATION,
    SAVE_DATA,
    SET_ONEBLOCK_SUCCESS,
